...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "FinSage AI" },
      ...
      { name: "twitter:title", content: "FinSage AI — Verified finance & compliance copilot for Indian MSMEs" },
      { name: "twitter:description", content: "Evidence-backed answers to GST, TDS and ROC questions for Indian small businesses. Every answer comes with an Honesty Score." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/9d739b74-6584-474a-bb3a-5379e3972b97" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/9d739b74-6584-474a-bb3a-5379e3972b97" },
    ],
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Noto+Sans+Devanagari:wght@400;500;600;700&family=Noto+Sans+Tamil:wght@400;500;600;700&display=swap" },
    ],
  }),
